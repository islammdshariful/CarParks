 ...
 * @author Aspire
 */
public class ChangePasswordForAdmin extends javax.swing.JFrame {
    ...
    public ChangePasswordForAdmin(String uid) {
        initComponents();
        u = uid;
    }
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        String query = "select * from admin where AdminID = '" + u + "' ;";
        ResultSet result = database.execQuery(query);
        
        String query1 = "update admin set AdminPassword = '" + ConPass + "' where AdminID = '"+ u + "' ;";
        
        try {
            while(result.next()){
                String id = result.getString("AdminID");
                String old = result.getString("AdminPassword");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePasswordForAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
